...
class produkController {
    ...
    static async delete(req, res) {
        try {
            ...
            // Simpan nama file sebelum diubah
            const oldFileName = product.gambar;
    
            // Update nama file di database (gunakan format 'delete-' + namaFile)
            const updatedGambar = 'delete-' + oldFileName;
    
            // Ubah nama file di sistem penyimpanan
            const oldFilePath = path.join(__dirname, '..', 'uploads', oldFileName);
            const newFilePath = path.join(__dirname, '..', 'uploads', updatedGambar);
